...
<div class="conten-crud">
    ...
    <ol style="display: block;" class="breadcrumb">
        ...
        <li><a href="#">culminar proyectos</a></li>
    </ol>

	<h1 class="title-crud">Culminar Proyectos</h1>

	<div class="alert-sigepsi">
		<p>
			Este formulario le permitirá culminar o enviar a corrección el proyecto seleccionado. En la parte inferior podrá observar los datos del proyecto para validar alguna información que considere necesaria.
		</p>
	</div>
	...
	<?php $form = ActiveForm::begin(); ?>
		<div class="col-sm-6">
			...
			<select class="form-control" name="" id="estatus">
				...
				<option value="4">Culminar</option>
				<option value="97">Corregir</option>
			</select>
		</div>
        ...
        <div class="form-group">
        	<button id="validar_proyecto" style="margin-top: 20px;" class="btn btn-success" type="button">Culminar proyecto</button>
        </div>
...
$script = <<< JS
	...
	document.getElementById("estatus").addEventListener('change', (event) => {
		if(document.getElementById("estatus").value == 97)
		{
    ...
    $("#validar_proyecto").click(function(event) {
                ...
                //---------------------
                    ...
                    $.ajax({
                        ...
                        .done(function(response) {
                            ...
                            {
                                document.querySelector(".preloader").style.display = "none";
                                AlertSigepsi("El proyecto ha sido sometido a corrección", "¡Se ha enviado un correo a cada integrante del proyecto para que esten al tanto de las correcciones!", "fas fa-check", "success", "http://localhost:8080/sigepsi/web/index.php?r=proyectos%2Fview&id="+id_proyecto+"");
                            }
           ...
           if(estatus == 4)
           {
                ...
                AlertSigepsiConfirm("¿Estas seguro que deseas culminar este proyecto?", "¡El proyecto pasara a estar en estatus de culminación!", "fas fa-exclamation-circle", "", "Cancelar", "Culminar");
                ...
                $("#si").click(function(event) {
                    ...
                    var url = "sigepsi/web/index.php?r=proyectos/culminado";
                ...
                //---------------------
                    ...
                    $.ajax({
                        ...
                        .done(function(response) {
                            ...
                            if(response.data.message == "El proyecto ha sido culminado.")
                            {
                                document.querySelector(".preloader").style.display = "none";
                                AlertSigepsi("El proyecto ha sido culminado exitosamente", "¡Se ha enviado un correo a cada integrante del proyecto para que esten al tanto de la culminación!", "fas fa-check", "success", "http://localhost:8080/sigepsi/web/index.php?r=proyectos%2Fview&id="+id_proyecto+"");
                            }
                            
                            })
                            .fail(function() {
                                console.log("error");
                                AlertSigepsi("Ocurrió un error al culminar el proyecto", "¡Intenta nuevamente!", "fas fa-times-circle", "warning");
                                document.querySelector(".preloader").style.display = "none";   
                                });
                });
