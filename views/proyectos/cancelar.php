...
<div class="conten-crud">
    ...
    <ol style="display: block;" class="breadcrumb">
        ...
        <li><a href="#">cancelar proyectos</a></li>
    </ol>

	<h1 class="title-crud">Cancelar Proyectos</h1>

	<div class="alert-sigepsi">
		<p>
			Este formulario le permitirá cancelar el proyecto seleccionado. En la parte inferior podrá observar los datos del proyecto para validar alguna información que considere necesaria.
		</p>
	</div>
	...
	<?php $form = ActiveForm::begin(); ?>
		<div class="col-sm-6">
			...
			<select class="form-control" name="" id="motivo_cancelacion">
				<option value>Seleccione</option>
				<?php
				foreach ($cancelacion as $cancelacion) 
				{
					?>
					<option value="<?= $cancelacion['id_proyecto_motivo_cancelacion'] ?>"><?= $cancelacion['proyecto_motivo_cancelacion'] ?></option>
					<?php
				}
				?>
			</select>
        ...
        <div class="form-group">
        	<button id="cancelar_proyecto" style="margin-top: 20px;" class="btn btn-danger" type="button">Cancelar proyecto</button>
        </div>
...
$script = <<< JS
    ...
    $("#cancelar_proyecto").click(function(event) {
           ...
           AlertSigepsiConfirm("¿Estas seguro que deseas cancelar este proyecto?", "¡Si lo cancelas el proyecto estara en estatus de cancelación!", "fas fa-exclamation-circle", "", "No cancelar", "Si, cancelar");
           ...
           $("#si").click(function(event) {
            ...
            alerta_sigepsi_confirm.style.display = 'none';
                        ...
                        var url = "sigepsi/web/index.php?r=proyectos/cancelado";
           ...
           //---------------------
            ...
            ValidateInputText('motivo_cancelacion'),
            ...
            $.ajax({
                ...
                if(response.data.message == "El proyecto ha sido cancelado.")
                {
                    document.querySelector(".preloader").style.display = "none";
                    AlertSigepsi("El proyecto ha sido cancelado", "¡Se ha enviado un correo a cada integrante del proyecto para que esten al tanto de la cancelación!", "fas fa-check", "success", "http://localhost:8080/sigepsi/web/index.php?r=proyectos%2Fview&id="+id_proyecto+"");
                }
