...
class TrayectosController extends Controller
{
    ...
    /**
     * Displays a single Trayectos model.
     * @param integer $id
     * @return mixed
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->id_trayecto]);
        }
    ...
    /**
     * Updates an existing Trayectos model.
    ...
    /**
     * Deletes an existing Trayectos model.
